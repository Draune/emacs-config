...
;; code from https://github.com/tumashu/vertico-posframe to get
;; which-key-posframe to work correctly with EXWM
...
(defun which-key-posframe-refposhandler-default (&optional frame)
  "The default posframe refposhandler used by which-key-posframe.
